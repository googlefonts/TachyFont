...
class GlyphRequest(webapp2.RequestHandler):
    """
    Service for glyph requests from the server
    Takes closure of glyphs and returns them as a bundle
    """
    def post(self):
      print self.request.body 
      self.response.headers["Content-Type"]= 'application/octet-binary;charset=latin1'
