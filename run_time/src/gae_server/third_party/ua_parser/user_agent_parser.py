...
regex_dir = ROOT_DIR if os.path.exists(
    os.path.join(ROOT_DIR, 'regexes.yaml')) else DATA_DIR
...
class UserAgentParser(object):
  ...
  def __init__(
      self, pattern, family_replacement=None, v1_replacement=None,
      v2_replacement=None):
...
class OSParser(object):
  ...
  def __init__(
      self, pattern, os_replacement=None, os_v1_replacement=None,
